...
if (
  ...
  if (!readerId) {
    ...
    // 🆕 Only trigger signature flow for NEW authorizations (not captures)
    ...
    } else if (isAlreadyCaptured) {
      console.log(`ℹ️ PaymentIntent ${pi.id} already captured - skipping signature prompt.`);
    }
  }
}
      // ================================================================
